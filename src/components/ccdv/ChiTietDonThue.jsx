...
const ChiTietDonThue = ({ sessionId, ccdvId, onBack }) => {
  ...
  // ✅ THÊM: Kiểm tra xem phản hồi có đang chờ duyệt không
  const isReportPending = session.status === "REVIEW_REPORT";

  // ✅ THÊM: Kiểm tra xem báo cáo đã được duyệt và hiển thị chưa
  const isReportApproved = session.status === "REPORTED";
          ...
          <div className="card shadow-sm">
            ...
            <div className="card-body">
              ...
              <div className="mb-3 p-3 bg-light rounded">
                ...
                <div className="ms-4">
                  <p className="mb-1">
                    <strong>Tên:</strong> {session.user.username}
                  </p>
                  <p className="mb-0">
        ...
        <div className="col-lg-4">
          ...
          <div className="card shadow-sm mb-4">
            ...
            <div className="card-body text-center">
              ...
              <small className="text-muted">
                ({duration} giờ × {formatMoney(session.totalPrice / duration)}
                /giờ)
              </small>
            </div>
          </div>
          ...
          <div className="card shadow-sm">
            ...
            <div className="card-body">
              ...
              {/* ✅ CHỈNH SỬA: Chỉ hiển thị phản hồi khi status là COMPLETED hoặc REPORTED */}
              {(session.status === "COMPLETED" || isReportApproved) &&
              isEditingFeedback ? (
                <>
                  <textarea
                ...
                <div>
                  {/* ✅ CHỈNH SỬA: Hiển thị phản hồi chỉ khi COMPLETED hoặc REPORTED */}
                  {session.status === "COMPLETED" || isReportApproved ? (
                    <>
                      {session.userReport ? (
                        <div
                          className={
                            isReportApproved ? "alert alert-danger" : ""
                          }
                        >
